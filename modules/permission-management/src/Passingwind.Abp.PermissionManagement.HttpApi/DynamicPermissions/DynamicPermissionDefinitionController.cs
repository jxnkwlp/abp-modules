...
[Route("api/permission-management/dynamic/definitions")]
public class DynamicPermissionDefinitionController : PermissionManagementController, IDynamicPermissionDefinitionAppService
{
