...
public class ClientDemoService : ITransientDependency
{
     ...
     */
    private void TestWithDynamicProxies()
    {
        Console.WriteLine();
        Console.WriteLine($"***** {nameof(TestWithDynamicProxies)} *****");
    }
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:DynamicPermissionManagement:BaseUrl"] +
                      "api/DynamicPermissionManagement/sample/authorized";
