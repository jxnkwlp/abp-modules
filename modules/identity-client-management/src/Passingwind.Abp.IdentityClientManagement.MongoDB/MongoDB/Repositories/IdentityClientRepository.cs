...
namespace Passingwind.Abp.IdentityClientManagement.MongoDB.Repositories;

public class IdentityClientRepository : MongoDbRepository<IdentityClientManagementMongoDbContext, IdentityClient, Guid>, IIdentityClientRepository
{
    public IdentityClientRepository(IMongoDbContextProvider<IdentityClientManagementMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
