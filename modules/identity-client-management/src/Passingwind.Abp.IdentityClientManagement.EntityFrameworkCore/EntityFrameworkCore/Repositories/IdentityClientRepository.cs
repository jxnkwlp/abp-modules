...
namespace Passingwind.Abp.IdentityClientManagement.EntityFrameworkCore.Repositories;

public class IdentityClientRepository : EfCoreRepository<IdentityClientManagementDbContext, IdentityClient, Guid>, IIdentityClientRepository
{
    public IdentityClientRepository(IDbContextProvider<IdentityClientManagementDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
