...
[Authorize(IdentityClientManagementPermissions.IdentityClient.Default)]
public class IdentityClientAppService : IdentityClientManagementAppService, IIdentityClientAppService
{
    ...
    [Authorize(IdentityClientManagementPermissions.IdentityClient.Create)]
    public virtual async Task<IdentityClientDto> CreateAsync(IdentityClientCreateDto input)
    {
        ...
        {
            throw new BusinessException(IdentityClientManagementErrorCodes.IdentityClientNameExists).WithData("name", input.Name);
        }
    ...
    [Authorize(IdentityClientManagementPermissions.IdentityClient.Update)]
    ...
    [Authorize(IdentityClientManagementPermissions.IdentityClient.Delete)]
