...
namespace Passingwind.Abp.Identity.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("Identity") == null)
        {
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["Identity_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
