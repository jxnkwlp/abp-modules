...
public class Saml2EventType : Saml2Events
{
    ...
    public override Task RedirectToIdentityProvider(RedirectContext context)
    {
        ...
        Logger.LogDebug("Authentication schame {0} request identity provider payload: \n{1}", providerName, xml);
        Logger.LogDebug("Authentication schame {0} redirect to identity provider url: \n{1}", providerName, context.RedirectBinding.RedirectLocation.OriginalString);
    ...
    public override Task MessageReceived(MessageReceivedContext context)
    {
        ...
        Logger.LogDebug("Authentication schame {0} received response payload: \n{1}", providerName, xml);
